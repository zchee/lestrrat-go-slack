...
func New(options ...Option) *Server {
	...
	return &Server{
		...
		handlers: map[string]http.Handler{
			"apps.permissions.info":           http.HandlerFunc(unimplemented),
			"apps.permissions.request":        http.HandlerFunc(unimplemented),
			"apps.permissions.resources.list": http.HandlerFunc(unimplemented),
			"apps.permissions.scopes.list":    http.HandlerFunc(unimplemented),
			"apps.permissions.users.list":     http.HandlerFunc(unimplemented),
			"apps.permissions.users.request":  http.HandlerFunc(unimplemented),
			"apps.uninstall":                  http.HandlerFunc(unimplemented),
